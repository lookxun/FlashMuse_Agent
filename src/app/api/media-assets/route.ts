...
export async function GET(request: Request) {
  ...
  const assets = rows.map((row) => {
    ...
    return {
      ...
      promptSource,
      lockedType: true,
      previewMeta: resolveAssetPreviewMeta(media.previewMeta, { mediaType: media.mediaType, model: media.model, ratio: media.ratio, resolution: media.resolution, imageSize: media.imageSize, videoDuration: media.videoDuration, width: media.width, height: media.height, durationSeconds: media.durationSeconds }),
